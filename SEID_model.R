...
init_pop_i[1] <- 0  # Number of infectious
...
a <- 0.6                 # constant for density dependent growth (between 0 and 1)
...
################### SG EDITED FROM HERE
  ...
  death_rate <- pmax(deaths_per_capita + (1-a)*growth_rate*colSums(new_total[,1:3])/carrying_capacity,0) #SB amended to ensure >0
