...
init_pop_s[1] <- 999  # Number of susceptible

init_pop_i <- rep(0,n.patch)
init_pop_i[1] <- 1  # Number of infected

c_trace_tab[1,,1] <- init_pop_s # Set number of susceptible in forest
c_trace_tab[1,,2] <- init_pop_i # Set number of infected in forest
